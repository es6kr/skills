...
Migrate Git repositories to ghq directory structure (bare+worktree → a regular `.git` at the ghq path).

This is the **inverse** of [to-bare](./to-bare.md) (regular repo → bare + worktree). Formerly named the `migrate` topic.
