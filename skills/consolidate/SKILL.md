...
1. **`pr.md`** Step 1 (Identify PR) + Step 2 (Skip Conditions) + Step 2.5 (Copilot sequential, multi-PR only) + Step 2.7 (checkout PR branch into a worktree — MANDATORY, all reviews)
