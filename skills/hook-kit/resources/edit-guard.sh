...
check_vendor_in_generic_skill() {
...

  {
    ...
    echo "      resolve the receiver from the workspace config"
    echo "      (workspace-config.sh --export -> WSCFG_<ROLE>_*);"
    echo "      a --<verb>=<skill>:<topic> flag stays an optional override"
