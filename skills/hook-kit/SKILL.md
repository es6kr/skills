...
| registry | canonical inventory `hook-registry.yaml` **relocated to a private companion repository** (2026-09-10) — consult before any registration change (owner/marketplace/status/tombstone); this topic is now a redirect | [registry.md](./registry.md) |
