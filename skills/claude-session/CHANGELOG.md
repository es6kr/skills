...
* **claude-session:** hook-based session ID lookup + new topics ([79a8f6e](https://github.com/es6kr/skills/commit/79a8f6e1e49668eb9e047b882a3387d7d6f4223f))


### Documentation

* **claude-session:** address AI review feedback on PR [#6](https://github.com/es6kr/skills/issues/6) ([37889c5](https://github.com/es6kr/skills/commit/37889c582f413923bf941c91a508babd0886f72b))
