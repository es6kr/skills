...
1. **Plan exists**: a `plan-*.md` artifact is present in the configured `output-dir` (see [SKILL.md](./SKILL.md) Configuration — resolved via `WSCFG_ARTIFACTS_PATH`, default `.agents/docs/generated` or workspace-configured path)
