...
## [0.10.0](https://github.com/es6kr/skills/compare/next-v0.9.2...next-v0.10.0) (2026-09-06)
...
## [0.3.0](https://github.com/es6kr/skills/compare/next-v0.2.0...next-v0.3.0) (2026-06-03)


### Features

* **next:** rename next-action to next, add stall-detect topic ([ce88856](https://github.com/es6kr/skills/commit/ce88856615f05e384fb2a1fdf1bfdd96cf19cfdb))
* **next:** separate in-progress vs waiting-on ask + trigger script ([3c94432](https://github.com/es6kr/skills/commit/3c94432169975f13d177f47ddd3afb52cf27fc1b))
* **release-please:** adopt release-please for monorepo version automation ([#7](https://github.com/es6kr/skills/issues/7) Phase 2) ([1cd02b8](https://github.com/es6kr/skills/commit/1cd02b861b0c8eb31b3be441c9ddab0870e5954b))
...
* **next:** clarify next-trigger.sh emits JSON, not a bare marker ([ca5389a](https://github.com/es6kr/skills/commit/ca5389a28050837ebbfb174d243345a616c94fa8))

## [0.2.0](https://github.com/es6kr/skills/compare/next-v0.1.1...next-v0.2.0) (2026-05-24)
