...
2. Follow Stage 1 (`task-plan`) to research prior decisions and structure the deliverable.
3. Pass through the mandatory User Review Gate (`AskUserQuestion`).
4. Follow Stage 2 (`task-exec`) to implement via TDD, verify empirical evidence, and deliver via PR.
